...
7	\N	jl	kota	Indonesia	Umum	+62 85691919544
8	dzikri	jl	kota	Indonesia	Umum	+62 85691919544
\.
...
SELECT pg_catalog.setval('public.master_doctor_doctor_id_seq', 9, true);
...
SELECT pg_catalog.setval('public.master_service_service_id_seq', 10, true);
...
SELECT pg_catalog.setval('public.pricelists_pricelist_id_seq', 38, true);
