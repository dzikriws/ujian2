...
-- Started on 2025-03-18 15:54:41
...
--
-- TOC entry 233 (class 1259 OID 55507)
...
--
-- TOC entry 232 (class 1259 OID 55502)
...
--
-- TOC entry 4737 (class 2604 OID 55336)
...
--
-- TOC entry 4738 (class 2604 OID 55345)
...
--
-- TOC entry 4739 (class 2604 OID 55352)
...
--
-- TOC entry 4740 (class 2604 OID 55359)
...
--
-- TOC entry 4741 (class 2604 OID 55375)
...
--
-- TOC entry 4742 (class 2604 OID 55391)
...
--
-- TOC entry 4743 (class 2604 OID 55398)
...
--
-- TOC entry 4906 (class 0 OID 55333)
-- Dependencies: 218
...
11	te	jl. test	Makau	Thailand	Spesialis	+66 6212313112
12	&lt;script&gt;alert(&quot;test&quot;);&lt;&#x2F;script&gt;	&lt;script&gt;alert(&quot;test&quot;);&lt;&#x2F;script&gt;	&lt;script&gt;alert(&quot;test&quot;);&lt;&#x2F;script&gt;	Indonesia	Spesialis	+62 839131
\.


--
-- TOC entry 4908 (class 0 OID 55342)
-- Dependencies: 220
...
--
-- TOC entry 4910 (class 0 OID 55349)
-- Dependencies: 222
...
--
-- TOC entry 4912 (class 0 OID 55356)
-- Dependencies: 224
...
--
-- TOC entry 4914 (class 0 OID 55372)
-- Dependencies: 226
...
--
-- TOC entry 4915 (class 0 OID 55378)
-- Dependencies: 227
...
--
-- TOC entry 4917 (class 0 OID 55388)
-- Dependencies: 229
...
--
-- TOC entry 4919 (class 0 OID 55395)
-- Dependencies: 231
...
SELECT pg_catalog.setval('public.master_doctor_doctor_id_seq', 12, true);
...
SELECT pg_catalog.setval('public.master_service_category_service_category_id_seq', 13, true);
...
SELECT pg_catalog.setval('public.master_service_service_id_seq', 13, true);
...
SELECT pg_catalog.setval('public.pricelists_pricelist_id_seq', 44, true);
...
--
-- TOC entry 4745 (class 2606 OID 55340)
...
--
-- TOC entry 4749 (class 2606 OID 55354)
...
--
-- TOC entry 4747 (class 2606 OID 55347)
...
--
-- TOC entry 4751 (class 2606 OID 55363)
...
--
-- TOC entry 4753 (class 2606 OID 55377)
...
--
-- TOC entry 4755 (class 2606 OID 55393)
...
--
-- TOC entry 4757 (class 2606 OID 55400)
...
--
-- TOC entry 4903 (class 2618 OID 55505)
...
-- Completed on 2025-03-18 15:54:41
