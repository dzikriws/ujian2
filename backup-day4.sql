...
--
-- TOC entry 233 (class 1259 OID 55517)
...
--
-- TOC entry 234 (class 1259 OID 55527)
...
11	tessoi	jl. test	Makau	Singapore	Umum	+65 66666212313112
\.
...
50	5	1	1	400000.00	400000.00
50	2	1	1	175000.00	175000.00
50	2	1	1	175000.00	175000.00
51	1	1	1	75000.00	75000.00
52	1	1	1	75000.00	75000.00
53	3	2	1	100000.00	100000.00
\.
...
50	Laboratorium	3	testfe	2025-03-20	0.20	dzikri
51	IGD	11	aw	2002-12-12	0.15	dzikri
52	IGD	11	aw	2002-12-12	0.15	dzikri
53	Poli Gigi	1	12	1200-12-12	0.67	dzikri
\.
...
SELECT pg_catalog.setval('public.master_doctor_doctor_id_seq', 15, true);
...
SELECT pg_catalog.setval('public.master_service_category_service_category_id_seq', 16, true);
...
SELECT pg_catalog.setval('public.master_service_service_id_seq', 16, true);
...
SELECT pg_catalog.setval('public.pricelists_pricelist_id_seq', 55, true);
...
SELECT pg_catalog.setval('public.transactions_transaction_id_seq', 53, true);
...
--
-- TOC entry 4908 (class 2618 OID 55520)
...
--
-- TOC entry 4909 (class 2618 OID 55530)
